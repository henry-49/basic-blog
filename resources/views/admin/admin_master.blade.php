...
<head>
    ...
    <title>Tech Guru Consult - Admin Dashboard</title>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer mt-auto">
                <div class="copyright bg-white">
                    <p>
                        Tech Guru Consult &copy; <span id="copy-year">2025</span>
                        <a class="text-primary" href="http://www.techguruconsult.com/" target="_blank">TechGuruConsult, GmbH</a>.
                    </p>
                </div>
                <script>
                    var d = new Date();
