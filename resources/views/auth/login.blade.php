...
<head>
    ...
    <head>
        ...
        <title>Tech Guru Consult | Sign In</title>
...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">Tech Guru Consult</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; <span id="copy-year">2025</span> Copyright Tech Guru Consult by
                <a class="text-primary" href="http://www.techguruconsult.com/" target="_blank">Henry</a>.
            </p>
        </div>
